            ...
            <div className="login__logo">
                ...
                >
                    <g id="undraw_Ride_a_bicycle_2yok 1" clip-path="url(#clip0)">
                        <path
                            id="Vector"
                            d="M147.207 158.847C141.721 165.464 139.608 174.766 137.245 183.512C118.222 253.993 71.345 310.684 17.96 351.178C-4.64756 368.331 -4.19702 382 17.96 414C30.4233 432 45.0001 446 55.0001 458.353C66.0001 491 19.9224 530.664 11.2418 564.383C1.36979 602.747 9.41959 620.208 17.96 659C23.2264 682.878 5.46476 718.21 22.6557 732.815C36.803 760.693 82.1971 767.294 113 780C137.245 785.706 133.516 784.014 155.803 785.706C175.427 787.198 203.367 780.313 222 773C238.28 766.603 238 764 257 760.693C272.763 757.95 283.303 757.845 292.835 751C315.222 734.922 347.121 753.808 372.792 760.693C433.366 776.851 511 802 678 764C795.645 730 758.707 677.523 845.192 631C892.192 605.717 857.76 528.769 892.192 503C911.591 488.328 946.265 478.725 959.456 458.353C985.488 418.446 999.565 367.565 995.5 317.758C991.435 267.952 968.657 219.956 932.884 191.839C894.587 161.743 846.218 156.121 802.645 138.053C757.651 119.388 717.622 87.3116 673.057 67.2836C636.997 51.1226 597.754 43.1891 558.206 44.0654C518.657 44.9418 479.809 54.6056 444.509 72.3478C396.01 96.7237 346.85 153.594 292.835 157.912C254.348 160.897 177.264 122.612 147.207 158.847Z"
                        ...
                        <g id="left-wheel">
                            ...
                            <path
                                id="Vector_4"
                                d="M249.81 629.62C256.885 629.62 262.62 623.885 262.62 616.81C262.62 609.735 256.885 604 249.81 604C242.735 604 237 609.735 237 616.81C237 623.885 242.735 629.62 249.81 629.62Z"
                                fill="#535461"
                            />
                        </g>
                        <g id="right-wheel">
                        ...
                        <g id="bike">
                            ...
                            <path
                                id="Vector_47"
                                d="M548.48 126.99C548.48 136.273 544.792 145.175 538.229 151.739C531.665 158.303 522.763 161.99 513.48 161.99C504.197 161.99 495.295 158.303 488.731 151.739C482.167 145.175 478.48 136.273 478.48 126.99C478.48 126.41 478.48 125.83 478.48 125.25C478.711 115.967 482.62 107.157 489.346 100.756C496.073 94.3555 505.067 90.8893 514.35 91.12C523.633 91.3508 532.443 95.2595 538.844 101.986C545.244 108.713 548.711 117.707 548.48 126.99Z"
                                fill="#DB8B8B"
                            />
                            <path
                                id="Vector_48"
                            ...
                            <path
                                id="Vector_50"
                                d="M442.992 600.736L442.984 600.742C439.977 602.991 439.362 607.253 441.611 610.26L461.937 637.441C464.186 640.448 468.447 641.063 471.455 638.814L471.463 638.808C474.471 636.559 475.085 632.297 472.836 629.29L452.51 602.109C450.261 599.102 446 598.487 442.992 600.736Z"
                                fill="black"
                            />
                            <path
                                id="Vector_51"
                    ...
                    <defs>
                        ...
                        >
                            ...
                            <stop offset="1" stop-color="#FA00FF" stop-opacity="0.92" />
                        </linearGradient>
                        <clipPath id="clip0">
